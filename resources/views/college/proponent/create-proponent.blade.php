                ...
                <div class="container-fluid py-2">
                    <div class="card table-container">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-sm-9">
                                <h3 class="card-heading py-3 d-flex"><ion-icon name="person-add-outline" size="large"></ion-icon> Create New Proponent Account </h3>

                                </div>
                            </div>
                        </div>
                        <div class="card-body card-body-proposal">
                            <form class="proposal-form" action="{{ route('create-proponent-college') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="row py-5">
                                    ...
                                    <div class="proposal-file-link ml-5 pt-3 pb-5">
                                        ...
                                        <div class="text-center file-upload m-0 filePicWidth filePicHeight">
                                            <div class="file-upload-cont filePicWidth">
                                                <label >
                                                    <input type="file" name="fileInputPic" class="inputFile" accept="image/png, image/jpeg, image/jpg">
                                ...
                                <div class="col-xl-6 col-sm-12">
                                    <div class="form-group text-left">
                                        ...
                                        <div class="input-group" id="InputFirstName">
                                            <input type="text" class="form-control" id="InputFirstName" name="firstname" placeholder="Enter faculty first name" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-left">
                                        ...
                                        <div class="input-group" id="InputMiddleName">
                                            <input type="text" class="form-control" id="InputMiddleName" name="middlename" placeholder="Enter faculty middle name">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-left">
                                        ...
                                        <div class="input-group" id="InputLastName">
                                            <input type="text" class="form-control" id="InputLastName" name="lastname" placeholder="Enter faculty last name" required>
                                        </div>
                                    </div>

                                    <div class="form-group text-left">
                                        <label for="InputEmployeeEmail" class="card-heading py-3">Employee Email <a tabindex="0" class="colored" role="button" data-toggle="popover" data-trigger="hover" data-html="true" data-content="Email must be existing and in compliance with our <a href='#'>terms and conditions</a>. Proponent will receive an email for their password."><i class="fa fa-info-circle"></i></a></label>
                                        <div class="input-group" id="InputEmployeeEmail">
                                            <input type="text" class="form-control" id="InputEmployeeEmail" name="email" placeholder="Enter employee email" required>
                                        </div>
