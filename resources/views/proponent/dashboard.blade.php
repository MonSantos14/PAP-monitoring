                ...
                <table class="table table-hover bg-white">
                  ...
                  <tbody>
                      @if ($proposals->count())
                        ...
                        <tr class="clickable-row" data-href="{{ route('proposal-view-proponent',$proposal->id) }}">
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="proposal-form" action="{{ route('dashboard-proponent') }}" method="POST">
                @csrf
              <div class="form-group text-left">
                <label for="InputProposal" class="form-label-txt">Proposal Title</label>
                <input type="text" class="form-control" name="proposal_title" id="InputProposal" placeholder="Enter Proposal Title" required>
              </div>
